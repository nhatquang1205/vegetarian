...
namespace vegetarian.Features.Blogs.GetPublicEvents
{
    public class Endpoint : Endpoint<PaginationRequest, PaginationResponse<BlogResonse>>
    {
        ...
        {
            // Get the categories
            var (total, blogs) = await BlogRepository.GetPublicBlogsAsync(req, Commons.AppEnums.BlogType.Event);
